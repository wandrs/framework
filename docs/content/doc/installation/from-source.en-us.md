...
- To set the `CustomPath` use `LDFLAGS="-X \"go.wandrs.dev/framework/modules/setting.CustomPath=custom-path\""`
- For `CustomConf` you should use `-X \"go.wandrs.dev/framework/modules/setting.CustomConf=conf.ini\"`
- For `AppWorkPath` you should use `-X \"go.wandrs.dev/framework/modules/setting.AppWorkPath=working-path\"`
- For `StaticRootPath` you should use `-X \"go.wandrs.dev/framework/modules/setting.StaticRootPath=static-root-path\"`
- To change the default PID file location use `-X \"go.wandrs.dev/framework/modules/setting.PIDFile=/run/gitea.pid\"`
